...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'trainset/train.txt',
...
weights = dict(filepath='workdir/tinaface/epoch_21_weights.pth')
optimizer = dict(filepath='workdir/tinaface/epoch_21_optim.pth')
meta = dict(filepath='workdir/tinaface/epoch_21_meta.pth')
